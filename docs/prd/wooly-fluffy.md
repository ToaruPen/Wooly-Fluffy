...
- Push-to-talk（PTT）を職員が操作し、待機中は無反応にできる
...
- 職員がPTTを開始/終了でき、KIOSKが録音開始/停止し、STT結果に応じて会話が進む
...
FR-2
機能名: Push-to-talk（職員操作）
説明: 待機中は無反応。職員がPTT中のみ収録/認識を開始し、責任の所在を職員側に寄せる。
優先度: Must
