...
if [ "$DRY_RUN" = false ] && [ "$FORCE" = false ]; then
	...
	scan_conflict_dir "$SOURCE_ROOT/scripts" "$TARGET_DIR/scripts/agentic-sdd"
	...
	if [ "$CI" = "github-actions" ]; then
		...
		scan_conflict_file "$SOURCE_ROOT/templates/ci/github-actions/scripts/agentic-sdd-ci.sh" "$TARGET_DIR/scripts/agentic-sdd/agentic-sdd-ci.sh"
		scan_conflict_file "$SOURCE_ROOT/templates/ci/github-actions/scripts/agentic-sdd-pr-autofix.sh" "$TARGET_DIR/scripts/agentic-sdd/agentic-sdd-pr-autofix.sh"
	fi
...
if [ "$CI" = "github-actions" ]; then
	...
	copy_file "$SOURCE_ROOT/templates/ci/github-actions/scripts/agentic-sdd-ci.sh" "$TARGET_DIR/scripts/agentic-sdd/agentic-sdd-ci.sh"
	copy_file "$SOURCE_ROOT/templates/ci/github-actions/scripts/agentic-sdd-pr-autofix.sh" "$TARGET_DIR/scripts/agentic-sdd/agentic-sdd-pr-autofix.sh"
fi
