...
usage() {
	cat <<'EOF'
Usage: scripts/agentic-sdd/cleanup.sh [issue-number | --all] [options]
...
Examples:
./scripts/agentic-sdd/cleanup.sh 123                    # Clean up Issue #123
./scripts/agentic-sdd/cleanup.sh 123 --dry-run          # Preview cleanup
./scripts/agentic-sdd/cleanup.sh --all                  # Clean up all merged worktrees
./scripts/agentic-sdd/cleanup.sh --all --dry-run        # Preview all cleanups
