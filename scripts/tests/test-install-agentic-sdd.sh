...
if [[ ! -f "$proj4/scripts/agentic-sdd/agentic-sdd-ci.sh" ]]; then
	eprint "Expected CI script to be installed: scripts/agentic-sdd/agentic-sdd-ci.sh"
	exit 1
fi

if [[ ! -f "$proj4/scripts/agentic-sdd/agentic-sdd-pr-autofix.sh" ]]; then
	eprint "Expected PR autofix script to be installed: scripts/agentic-sdd/agentic-sdd-pr-autofix.sh"
	exit 1
fi
