...
const ASYNC_TEST_TIMEOUT_MS = 5_000;
...
describe("http-server", () => {
  describe("staff auth and keepalive", () => {
    it(
      "sets staff session cookie Max-Age from default TTL",
      async () => {
    ...
    it(
      "sets staff session cookie Max-Age from env override",
      async () => {
        await closeServerWithTimeout(server);
    ...
    it(
      "returns 200 for staff keepalive with valid session",
      async () => {
    ...
    it(
      "returns 401 for staff keepalive without session",
      async () => {
        const response = await sendRequest("POST", "/api/v1/staff/auth/keepalive");
    ...
    it(
      "returns 405 for staff keepalive with non-POST",
      async () => {
    ...
    it(
      "does not crash on invalid URL encoding",
      async () => {
  ...
  describe("route guards and lifecycle", () => {
    it(
      "returns 405 for stt-audio with non-POST",
      async () => {
    ...
    it(
      "returns 404 for staff pending list with non-GET",
      async () => {
    ...
    it(
      "returns 401 for staff session summary list without session",
      async () => {
    ...
    it(
      "returns 405 for staff session summary list with non-GET",
      async () => {
    ...
    it(
      "returns 413 for stt-audio with too large body",
      async () => {
    ...
    it(
      "skips snapshot broadcast when unchanged",
      async () => {
    ...
    it(
      "returns 404 for legacy staff pending list endpoint",
      async () => {
    ...
    it(
      "broadcasts staff snapshot after staff event",
      async () => {
    ...
    it(
      "creates pending session summary after inactivity",
      async () => {
    ...
    it(
      "broadcasts staff snapshot when pending session summary is created",
      async () => {
        const savedTickInterval = process.env.WF_TICK_INTERVAL_MS;
        const savedInactivityTimeout = process.env.WF_INACTIVITY_TIMEOUT_MS;
        process.env.WF_TICK_INTERVAL_MS = "50";
    ...
    it(
      "swallows event processing errors to keep server alive",
      async () => {
    ...
    it(
      "returns 404 for staff pending confirm when id not found",
      async () => {
    ...
    it(
      "returns 404 for staff pending confirm with non-POST",
      async () => {
    ...
    it(
      "returns 404 for staff pending deny with non-POST",
      async () => {
    ...
    it(
      "returns 405 for staff session summary confirm with non-POST",
      async () => {
    ...
    it(
      "returns 405 for staff session summary deny with non-POST",
      async () => {
